...
@class SBRootFolderController; @class SBFloatyFolderView; @class SBFolderIconListView; @class SBFolderController; @class SBFloatyFolderController; @class SBApplicationController; @class SBFolderView; @class SBIconListModel; 
...
static SBFolderController* _logos_method$Universal$SBFolderController$initWithConfiguration$(_LOGOS_SELF_TYPE_INIT SBFolderController* __unused self, SEL __unused _cmd, id arg1) _LOGOS_RETURN_RETAINED {
	self = _logos_orig$Universal$SBFolderController$initWithConfiguration$(self, _cmd, arg1);
	if (self) {
